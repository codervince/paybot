...
TipBot.prototype.tellHelp = function(channel) {
    console.log(channel.send(
        "*PAYBOT COMMANDS* \n" +
        "Please note all withdrawals subject to a 5% fee - thanks!" +
        ...
        " - *convert*\task the bot to convert between a particular currency and bitcoin (or visa versa); _@paybot 1 USD to EUR!_ \n" +
